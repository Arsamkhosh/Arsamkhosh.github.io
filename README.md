...
<style>
  ...
  .chat-options button {
    width: 100%; padding: 10px; border: none; border-bottom: 1px solid #00ffff; background: transparent; color: #fff; cursor: pointer; transition: 0.3s;
  }
...
<section id="about-me">
  <h2>درباره من</h2>
  <p>
    سلام! من <strong>ارسام خوش‌اخلاق</strong> هستم، علاقه‌مند به طراحی وب، رابط کاربری، و تجربه کاربری. این سایت رو راه‌اندازی کردم تا پروژه‌های شخصی‌ام رو به نمایش بذارم، با دیگران ارتباط برقرار کنم، و بستری برای همکاری‌های حرفه‌ای فراهم کنم.
  </p>
  <p>
    اگر پیشنهادی، سوالی یا علاقه‌مندی به همکاری داری، خوشحال می‌شم از طریق فرم تماس یا اینستاگرام باهام در ارتباط باشی.
  </p>
</section>
